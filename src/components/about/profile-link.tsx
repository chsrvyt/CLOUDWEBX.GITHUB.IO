...
/** A founder's outbound profile — the shared GoldButton with the right icon,
 *  rising in as the founder's row scrolls into view. */
export function ProfileLink({
  ...
  return (
    <GoldButton
      ...
      external
      arrow="↗"
      icon={kind === "linkedin" ? <LinkedInIcon /> : <GlobeIcon />}
      ariaLabel={`${owner} — ${label}`}
      rise
      order={order}
    >
      {label}
